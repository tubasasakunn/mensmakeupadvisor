...
extension FaceDiagramView {
    func drawBaseOverlay(
        ...
        ctx.fill(Path(ellipseIn: faceRect), with: .color(Theme.Diagram.faceLayerSoft))
    }
    ...
    func drawHighlightOverlay(
        ...
        let hl = Theme.Diagram.highlightArea
    ...
    func drawShadowOverlay(
        ...
        let sh = Theme.Diagram.shadowArea
    ...
    func drawEyesOverlay(
        ...
        let hl = Theme.Plate.dashedEllipse
